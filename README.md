...
A challenging case in web search and question answering are count queries, such as “number of songs by John Lennon”. Prior methods
...
- `stresstest_v1` - curated set of challenging count queries and their groundtruth inference.
